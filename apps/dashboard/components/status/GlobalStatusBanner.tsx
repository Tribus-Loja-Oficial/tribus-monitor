...
export function GlobalStatusBanner({ status, lastUpdatedLabel }: GlobalStatusBannerProps) {
  if (status === 'incident_active') {
    return (
      <div className="rounded-2xl border border-rose-300 bg-rose-50 px-5 py-4 text-rose-800 shadow-sm">
  ...
  return (
    <div className="rounded-2xl border border-emerald-300 bg-emerald-50 px-5 py-4 text-emerald-800 shadow-lg shadow-emerald-200/60">
